				...
				<TouchableOpacity
					...
					<View
						style={[{
							...
							borderRadius: this.props.switchBorderRadius !== undefined ?
								this.props.switchBorderRadius : this.state.sbHeight / 2,
							borderWidth: 1,
					...
					>
						<View
							style={[{
								flexDirection:
									this._switchDirection(this.props.switchdirection || this.state.direction)
							}]} >
							...
							>
								<Text 
									style={[this.state.activeSwitch === 2 ? 
									{ color: this.props.activeFontColor || "#fff" } : 
									{ color: this.props.fontColor || "#b1b1b1" }]}>
